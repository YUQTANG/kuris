    ...
    <div id="left_menu">
        <ul id="TabPage2" style="height:200px; margin-top:50px;">
            ...
            <li id="left_tab2" title="系统管理" data-rootmenu="systemManage">
                <img alt="系统管理" title="系统管理" src="/images/common/2.jpg"
                     width="33" height="31">
            </li>
    ...
    <div id="left_menu_cnt">
        ...
        <div id="nav_resource">
            <ul id="dleft_tab1" class="ztree">
                <%--<p><a href="/department/list.do" target="right">部门管理</a></p>
                <p><a href="/employee/list.do" target="right">员工管理</a></p>
                <p><a href="/permission/list.do" target="right">权限管理</a></p>
                <p><a href="/role/list.do" target="right">角色管理</a></p>--%>
            </ul>
        </div>
    </div>
</div>
